from semantic_layer_data_preparation.workloads.sample_etl_job import SampleETLJob
from semantic_layer_data_preparation.workloads.sample_ml_job import SampleMLJob
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/semantic-layer-data-preparation/sample_experiment"
    }
